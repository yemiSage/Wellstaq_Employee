...
export function SupportScreen() {
  const form = useForm<{ subject: string; message: string; category: string }>({ defaultValues: { subject: "", message: "", category: "general" }, mode: "onChange" });
