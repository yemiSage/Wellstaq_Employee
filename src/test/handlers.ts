...
const base = "https://wellstaq-api-production.up.railway.app";
...
export const handlers = [
  ...
  http.get(`${base}/organizations/:orgId/events`, () => HttpResponse.json({ items: [{ id: "event-1", title: "Mindful reset", start_date: "2099-09-04", participant_count: 12 }], total: 1, offset: 0, limit: 20 })),
