...
test('all employee detail routes render after a direct reload',async({page})=>{
  ...
  for(const [path,title]of [['scores','Personal scores'],['assessments','Assessments'],['priorities','My priorities'],['survey','Wellbeing survey'],['history','Check-in history'],['challenges','Challenges'],['challenges/challenge-1','Challenge'],['events/event-1','Event details'],['posts/new','Share a moment'],['posts/post-1','Community post'],['stories/new','Add a story'],['stories/story-1','A shared moment'],['clubs','Clubs'],['clubs/club-1','Your community'],['clubs/club-1/chat','The walking club'],['movement','Movement'],['leaderboard','Leaderboard'],['profile','Profile'],['preferences','Preferences'],['security','Password & 2FA'],['sessions','Active sessions'],['support','Support'],['notifications','Notifications']]){
